...
# arbitrage_using_kedro documentation build
...
from arbitrage_using_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "arbitrage_using_kedro"
copyright = "2018-2019, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "arbitrage_using_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "arbitrage_using_kedro.tex",
        "arbitrage_using_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "arbitrage_using_kedro",
        "Project arbitrage_using_kedro codebase.",
        "Data-Science",
    )
]
